...
p90 = Preset("P90", 50, 0, 25, 200, 250, 70, WeaponType("SMG", "Small Arms"),fireMode=['s','fa'])
miniuzi = Preset("Mini-Uzi", 32, 0, 50, 150, 250, 60, WeaponType("SMG", "Small Arms"),fireMode=['s','fa'])
